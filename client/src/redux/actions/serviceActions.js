...
export const toggleServiceOnlineOffline = (data: { status: number, responseMsg: string, updatedService: ServiceData, updatedServicesArr: Array<ServiceData> }): ToggleServiceOnlineOffline => {
 return {
